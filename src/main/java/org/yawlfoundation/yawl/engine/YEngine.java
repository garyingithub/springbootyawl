...
public class YEngine implements InterfaceADesign,
    ...
    private static boolean _persisting=true;
   ...
   /*****************************************************************************/
    ...
    protected YIdentifier startCase(YSpecificationID specID, String caseParams,
                                    ...
                                    String tenantId, YLogDataItemList logData, String serviceRef, boolean delayed)
        ...
        YNetRunner runner = new YNetRunner(_pmgr, specification.getRootNet(), data, caseID,tenantId);
        _netRunnerRepository.add(runner);
    ...
    public String launchCase(YSpecificationID specID, String caseParams,
        ...
        return launchCase(specID, caseParams, completionObserver, null, null,logData, null, false);
    }
    ...
    public String launchCase(YSpecificationID specID, String caseParams,
            ...
            throws YStateException, YDataStateException,
            YPersistenceException, YEngineStateException, YQueryException {
        return launchCase(specID, caseParams, completionObserver, null, null,logData, serviceHandle, false);
    }


    public String launchCase(YSpecificationID specID, String caseParams,
                             URI completionObserver, String caseID, String tenantId,
        ...
        synchronized(_pmgr) {
            ...
            try {
                YIdentifier yCaseID = startCase(specID, caseParams, completionObserver,
                        caseID, tenantId,logData, serviceHandle, delayed);
                if (yCaseID != null) {
                    commitTransaction();
